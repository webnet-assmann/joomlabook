...
image::17/14_berechtigungen_einstellen.png[Berechtigungen für das Feld einstellen]
...
image::17/15_eigenes_feld_benutzerregistrierung.png[Unser eigenes Feld in der Benutzerregistrierung]
...
image::17/16_einstellungen_radio_feld.png[Einstellungen der Werte im Radio-Feld]
...
image::17/17_optionen_checkbox_feld.png[Abbildung der Optionen für das Checkbox-Feld]
...
image::17/18_auswahl_mail_feldgruppe.png[Auswahl des Kontext Mail]
...
image::17/19_rechte_beitraege_erstellen.png[Rechte für das Erstellen von Beiträgen einstellen]
...
image::17/20_eingabeformular_frontend.png[Eingabeformular im Frontend]
...
image::17/21_automatische_anzeige_feld_frontend.png[Automatische Anzeige der Felder im Frontend]
...
image::17/22_individuelle_ausgabe.png[Individuelle Ausgabe der Anzeige]
