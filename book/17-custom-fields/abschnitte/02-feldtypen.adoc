...
Bild 17.2 – Generelle Feldeinstellungen im Reiter „Optionen“
...
Bild 17.3 – Das neue Joomla!-Kalenderfeld
...
Bild 17.5 – Das Design des Optionsfelds
...
Bild - 17.6 Subformfeld im Layout Formular
