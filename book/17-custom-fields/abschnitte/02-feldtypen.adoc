...
Das Feld Subform löst das Repeatable Feld ab. Mit dem Feld Subform 
lassen sich ein oder mehrere angelegte Felder auswählen, die dann im 
Beitrag ausgefüllt werden können und im Frontend zusammen angezeigt werden. 
Damit lassen sich z.B. eigene Listen oder Tabellen erstellen. Es kann eine 
maximale Wiederholung eingegeben werden.
In den Feldeinstellungen lässt sich einstellen, ob man bei Optionsfelder den 
Wert des Feldes ausgeben möchte oder nicht.
Das Layout der Felder im Subform kann mit der Eingabemaske-Option 
“Formular Layout” bestimmt werden. Standardmäßig werden die Felder als Tabelle 
nebeneinander angezeigt. Bei mehreren Feldern kann dies sehr schnell 
unübersichtlich werden. Hier empfiehlt sich das Layout Formular. Damit werden 
die Felder gebündelt untereinander angezeigt.
