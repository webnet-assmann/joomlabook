...
.Schaltfläche im _tinyMCE_-Editor
image::17/09_schaltflaeche_tinymce.png[Schaltfläche im tinyMCE-Editor]

.Fenster zur Auswahl von Modulen
image::17/10_fenster_auswahl_module.png[Fenster zur Auswahl von Modulen]
...
zunächst sicherstellen, dass Ihr Layout über den im Listing 17.2
angezeigten Code Zugriff auf das Userobjekt, den Beitragsautor und die
dazugehörigen Felder hat.

Listing 17.2 – Abrufen des Benutzers im Beitragslayout
...
Parameter aus der Automatischen Anzeige aus Kapitel 17.05 verwenden,
um die Ausgabe der Felder zu steuern oder unter KOMPONENTE » KONTAKT »
KONTAKT BEARBEITEN im Reiter WEITERE INFORMATIONEN den Editor-Button
(17.05) nutzen, um Felder an entsprechender Stelle auszugeben – so
...
KONTAKTANZEIGENOTIONEN die Einstellung _Eigene Felder anzeigen_. Die
gleiche Einstellung ist im Kontakt selbst im Reiter „ANZEIGE“ und in den
globalen Optionen der Kontakt-Komponente zu finden.

.Einstellung der Anzeige von Benutzer-Feldern im Kontakt
image::17/11_anzeige_felder_benutzer.png[Einstellung der Anzeige von Benutzer-Feldern im Kontakt]
...
/components/com++_++contact/tmpl/contact/default++_++user++_++custom++_++fields.php
...
_components/com++_++contact/tmpl/contact/default++_++form.php_
anlegen.

Sehen wir uns die Datei _default++_++form.php_ im Listing 17.3 an. In
dem Formular befindet sich in den Zeilen 26–41 eine foreach-Schleife,
...
Listing 17.3 – Anzeige der Datei
_components/com++_++contact/tmpl/contact/default++_++form.php_
...
. ++*++
. ++*++ @copyright Copyright (C) 2006 Open Source Matters, Inc.
All rights
. reserved.
...
Tabelle 17.2 – Aufruf der Felder über die
